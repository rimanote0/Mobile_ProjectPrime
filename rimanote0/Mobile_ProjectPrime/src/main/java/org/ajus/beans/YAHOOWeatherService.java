...
import com.etapix.beans.WeatherService;
...
public class YAHOOWeatherService implements WeatherService, Serializable {
	...
	public String getConditions(String task, String unit) {

		try {
			URL feedSource = new URL("http://weather.yahooapis.com/forecastrss?p=" + task + "&u=" + unit);
